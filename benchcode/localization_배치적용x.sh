...
for QPS in "${qps_values[@]}"; do
    ...
    wrk2 -t4 -c20 -d300s -R$QPS --latency "http://$clusterIP:11000/a?value=1" -s /home/dnc/master/paper2024/benchcode/load_test.lua | tee -a /home/dnc/master/paper2024/result/$paper_arg3/result${QPS}_1.txt
    ...
    wrk2 -t4 -c20 -d300s -R$QPS --latency "http://$clusterIP:11000/a?value=1" -s /home/dnc/master/paper2024/benchcode/load_test.lua | tee -a /home/dnc/master/paper2024/result/$paper_arg3/result${QPS}_2.txt
done
