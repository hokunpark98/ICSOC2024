...
for ((i=1; i<=repetitions; i++)); do
    result_dir="/home/dnc/master/paper2024/result/custom/proposed/${paper_arg3}_${i}"
    ...
    for QPS in "${qps_values[@]}"; do
        ...
        wrk2 -t2 -c10 -d120s -R$QPS --latency "http://$clusterIP:11000/a?value=1" -s /home/dnc/master/paper2024/benchcode/load_test.lua | tee -a "$result_dir/result${QPS}_1.txt"
        ...
        # 캐싱으로 인한 성능 향상 제거
        wrk2 -t2 -c10 -d60s -R$QPS --latency http://10.97.31.177:9080/productpage          
        wrk2 -t2 -c10 -d120s -R$QPS --latency "http://$clusterIP:11000/a?value=1" -s /home/dnc/master/paper2024/benchcode/load_test.lua | tee -a "$result_dir/result${QPS}_2.txt"
    done
done
