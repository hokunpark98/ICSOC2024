...
path="/home/dnc/master/customBench/yaml/deployment_optTraffic"
...
kubectl create -Rf /home/dnc/master/paper2024/trafficyaml/optTraffic/custom
sleep 60
# 캐싱으로 인한 성능 향상 제거
wrk2 -t4 -c10 -d60s -R50 --latency "http://$clusterIP:11000/a?value=1" 

for ((i=1; i<=repetitions; i++)); do
    result_dir="/home/dnc/master/paper2024/result/custom/optTraffic/${paper_arg3}_${i}"
